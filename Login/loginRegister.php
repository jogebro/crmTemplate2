    ...
    <div class="container-m">
        <div class="section1">
         ...
         <div class="d-flex justify-content-center align-items-center">
            <img src="../SuperMarket/images/logoSuperMarket.png" alt="" class="logo"></div>
        ...
        <div class="section2" id="section2">
            ...
            <div class="d-flex justify-content-center align-items-end m-5"><img src="../SuperMarket/images/subLogo.png" alt="" style="width: 50%; height: 10%; object-fit: cover;" ></div>
